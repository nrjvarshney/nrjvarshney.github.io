...
if __name__ == "__main__":
    ...
    model = ClassificationModel.load_from_checkpoint(other_arguments.checkpoint_path, other_arguments=other_arguments)
    ...
    train_params = dict(
        ...
        gpus=model.training_arguments.n_gpu,
        deterministic=True,
        max_epochs=other_arguments.num_train_epochs,
        precision=16 if model.training_arguments.fp_16 else 32,
        amp_level=model.training_arguments.opt_level,
        gradient_clip_val=model.training_arguments.max_grad_norm,
    ...
    if (model.training_arguments.distributed_backend != None):
        train_params["distributed_backend"] = model.training_arguments.distributed_backend
